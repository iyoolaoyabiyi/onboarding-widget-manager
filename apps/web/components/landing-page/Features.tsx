  ...
  return (
    <div ref={sectionRef} className="relative h-[600vh] bg-black">
      ...
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center overflow-hidden">
        {/* Section Header */}
        <div className="absolute top-20 text-center px-4 z-10">
          <motion.div
        ...
        <div ref={containerRef} className="relative w-full max-w-4xl h-[400px] flex items-center justify-center" style={{ perspective: "1000px" }}>
          ...
          {features.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="absolute w-full max-w-md bg-gray-900/70 backdrop-blur-lg border border-gray-700 rounded-2xl p-8 shadow-2xl"
              >
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-lg text-gray-400 mb-6">{item.description}</p>
          ...
          <motion.div
            ...
            className="absolute -bottom-20 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-gray-400"
          >
            <ArrowDown className="w-6 h-6 animate-bounce" />
            <span className="text-sm">Scroll for next feature</span>
          </motion.div>
        ...
        <div className="lg:hidden absolute bottom-20">
          <div className="flex items-center gap-4">
            <motion.div
              style={{ width: mobileProgressWidth }}
              className="h-1 bg-linear-to-r from-blue-600 to-blue-500 rounded-full max-w-[200px]"
            />
            <motion.span 
